...
3. Gere exatamente 3 hipóteses (Alta, Média, Baixa), cada uma com motivo breve e objetivo baseado apenas no caso.
4. Sugira plano diagnóstico custo-efetivo e seguro.
5. Foque conduta em encaminhamento, monitorização e estabilização.
6. Para cada hipótese, explique de forma breve, objetiva e direta o motivo clínico da classificação (Alta|Média|Baixa).
