...
export function buildMedbotLocalContent(params) {
  const referenceByTopic = {
    cardiologia: 'SBC 2023/2024 + ACC/AHA',
    neurologia: 'AHA/ASA Stroke Guidelines',
    infectologia: 'IDSA/OMS diretrizes atualizadas',
    emergencias: 'ATLS/ACLS e protocolos de triagem',
  };
  const referenceLabel = referenceByTopic[params.topicId] || 'Diretrizes clínicas reconhecidas';
