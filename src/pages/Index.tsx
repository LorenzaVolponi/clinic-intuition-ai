...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.95),_rgba(235,244,255,0.9)_55%,_rgba(223,239,255,0.85)_100%)] text-foreground">
      <header className="sticky top-0 z-50 border-b border-white/70 bg-white/80 backdrop-blur-xl shadow-[0_10px_35px_-25px_rgba(0,0,0,0.25)]">
        <div className="container mx-auto flex flex-wrap items-center justify-between gap-4 px-4 py-4">
          <button onClick={() => scrollToSection('inicio')} className="flex items-center gap-3 text-left">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-slate-500">AI Lab • diagnóstico educacional + estudo ativo</div>
            </div>
          </button>

          <div className="flex flex-wrap items-center gap-3">
            <div className="rounded-full border border-cyan-200 bg-white/90 px-4 py-2 text-sm font-semibold text-slate-600 shadow-sm">
              Sem menu fixo • foco no que o sistema faz
            </div>
            <div className="rounded-full border border-violet-200 bg-white/90 px-4 py-2 text-sm font-semibold text-slate-600 shadow-sm">
              Casos, MedBot, Flashcards, Quiz e Timeline
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
              <div className="relative z-10 text-center lg:text-left">
                ...
                <p className="mt-4 max-w-2xl text-base leading-7 text-slate-500 sm:text-lg">
                  Agora a plataforma foi organizada para mostrar com clareza o que ela faz: analisar casos fictícios, explicar hipóteses, treinar estudantes com flashcards e quiz por IA e contextualizar a evolução da medicina.
                </p>

                <div className="mt-6 grid gap-3 sm:grid-cols-3">
                  <div className="rounded-3xl border border-white/70 bg-white/80 p-4 text-left shadow-sm">
                    <div className="mb-2 flex items-center gap-2 text-sm font-bold text-cyan-600"><Stethoscope className="h-4 w-4" /> Diagnóstico educacional</div>
                    <p className="text-sm leading-6 text-slate-500">Triagem, hipóteses, exames-chave e ações imediatas para casos simulados.</p>
                  </div>
                  <div className="rounded-3xl border border-white/70 bg-white/80 p-4 text-left shadow-sm">
                    <div className="mb-2 flex items-center gap-2 text-sm font-bold text-emerald-600"><WandSparkles className="h-4 w-4" /> Estudo guiado por IA</div>
                    <p className="text-sm leading-6 text-slate-500">MedBot, revisão rápida, comparações clínicas e prompts acionáveis.</p>
                  </div>
                  <div className="rounded-3xl border border-white/70 bg-white/80 p-4 text-left shadow-sm">
                    <div className="mb-2 flex items-center gap-2 text-sm font-bold text-violet-600"><BookOpen className="h-4 w-4" /> Memória ativa</div>
                    <p className="text-sm leading-6 text-slate-500">Flashcards, quiz e timeline clicável para consolidar conteúdo.</p>
                  </div>
                </div>
